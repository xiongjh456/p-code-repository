...
public class SysResult<T> implements Serializable{
    ...
    public static <S> SysResult<S> build(Integer status, String msg, S data) {
        return new SysResult<>(status, msg, data);
    }

    public static <S> SysResult<S> build(ResultCodeEnum resultCodeEnum, S data){
        return new SysResult<>(resultCodeEnum.getStatus(), resultCodeEnum.getAlias(), data);
    }

    public static <S> SysResult<S> ok(S data) {
        return new SysResult<>(data);
    }

    public static <S> SysResult<S> ok() {
        return new SysResult<>(null);
    }

    public static <S> SysResult<S> fail(){
        return new SysResult<>(201, "失败", null);
    }

    public static <S> SysResult<S> fail(String message){
    ...
    public static <S> SysResult<S> build(Integer status, String msg) {
